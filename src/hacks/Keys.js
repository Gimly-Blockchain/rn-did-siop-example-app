...
exports.decrypt =
  exports.encrypt =
  exports.toSignatureObject =
  exports.getThumbprint =
  exports.getThumbprintFromJwk =
  exports.verifyJWTSignatureFromVerificationMethod =
  exports.getVerificationMethod =
  exports.getPublicJWKFromHexPrivateKey =
  exports.getPublicED25519JWKFromHexPrivateKey =
  exports.getBase58PrivateKeyFromHexPrivateKey =
  exports.getPublicJWKFromDIDHexPublicKey =
  exports.getPublicJWKFromHexPublicHex =
  exports.getHexPrivateKey =
  exports.isEd25519JWK =
  exports.isEd25519DidKeyMethod =
    void 0;
...
function getPublicJWKFromHexPublicHex(hexPublicKey, kid, method) {
  ...
  return {
    ...
    x: js_base64_1.default.fromUint8Array(
      pubPoint.getX().toArrayLike(Buffer),
      true,
    ),
    y: js_base64_1.default.fromUint8Array(
...
function getPublicJWKFromDIDHexPublicKey(hexPublicKey) {
  ...
  const publicKeyBase58 =
    did_key_ed25519_1.keyUtils.publicKeyBase58FromPublicKeyHex(hexPublicKey);
  return did_key_ed25519_1.keyUtils.publicKeyJwkFromPublicKeyBase58(
    publicKeyBase58,
  );
}
...
function getBase58PrivateKeyFromHexPrivateKey(hexPrivateKey) {
  return did_key_ed25519_1.keyUtils.privateKeyBase58FromPrivateKeyHex(
    hexPrivateKey,
  );
}
exports.getBase58PrivateKeyFromHexPrivateKey =
  getBase58PrivateKeyFromHexPrivateKey;
...
exports.getPublicED25519JWKFromHexPrivateKey =
  getPublicED25519JWKFromHexPrivateKey;
...
function verifyJWTSignatureFromVerificationMethod(jwt, verificationMethods) {
  ...
  if (
    header.alg === types_1.SIOP.KeyAlgo.EDDSA ||
    header.alg === types_1.SIOP.KeyAlgo.EDDSA
  ) {
...
exports.verifyJWTSignatureFromVerificationMethod =
  verifyJWTSignatureFromVerificationMethod;
...
function getThumbprintFromJwkImpl(jwk) {
  ...
  const buff = (0, sha_js_1.default)('sha256')
...
function getThumbprintFromJwkDIDKeyImpl(jwk) {
  ...
  const pubkeyBytes = bs58.decode(
    did_key_ed25519_1.keyUtils.publicKeyBase58FromPublicKeyJwk(jwk),
  );
...
function extractPublicKeyBytes(vm) {
  ...
  if (vm.publicKeyJwk) {
    return {
      x: (0, Encodings_1.isHexString)(vm.publicKeyJwk.x)
        ? vm.publicKeyJwk.x
        : (0, Encodings_1.base64ToHexString)(vm.publicKeyJwk.x),
      y: (0, Encodings_1.isHexString)(vm.publicKeyJwk.x)
        ? vm.publicKeyJwk.y
        : (0, Encodings_1.base64ToHexString)(vm.publicKeyJwk.y),
    };
  }
...
function verifyEDDSA(jwt, verificationMethod) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (verificationMethod.publicKeyBase58) {
      publicKey = did_key_ed25519_1.keyUtils.publicKeyJwkFromPublicKeyBase58(
    ...
    const result = yield (0, verify_1.default)(
      jwt,
      yield (0, parse_1.default)(publicKey, types_1.SIOP.KeyAlgo.EDDSA),
    );
...
function encrypt(payload, publicKeyHex) {
  return __awaiter(this, void 0, void 0, function* () {
    const encrypted = yield eth_crypto_1.default.encryptWithPublicKey(
      publicKeyHex,
...
function decrypt(privateKey, encrypted) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return eth_crypto_1.default.decryptWithPrivateKey(
      privateKey,
      encryptedObject,
    );
  });
